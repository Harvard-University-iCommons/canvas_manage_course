...
# Create a symlink from ~/canvas_manage_course to /vagrant as a convenience for the developer
file {'/home/vagrant/canvas_manage_course':
    ensure => link,
    target => '/vagrant',
}
...
exec {'create-virtualenv':
    ...
    user => 'vagrant',
    group => 'vagrant',
    require => [ Package['virtualenvwrapper'], File['/home/vagrant/canvas_manage_course'], File['/etc/profile.d/oracle.sh'],
                 Exec['known_hosts'], ],
    ...
    creates => '/home/vagrant/.virtualenvs/canvas_manage_course',
}

# set the DJANGO_SETTINGS_MODULE environment variable
file_line {'add DJANGO_SETTINGS_MODULE env to postactivate':
    ensure => present,
    line => 'export DJANGO_SETTINGS_MODULE=canvas_manage_course.settings.local',
    path => '/home/vagrant/.virtualenvs/canvas_manage_course/bin/postactivate',
...
file_line {'add DJANGO_SETTINGS_MODULE env to postdeactivate':
    ...
    path => '/home/vagrant/.virtualenvs/canvas_manage_course/bin/postdeactivate',
    require => Exec['create-virtualenv'],
}
...
exec {'init-db-and-migrate':
    ...
    unless => 'psql -lqt | cut -d \| -f 1 | grep -wq canvas_manage_course',
    logoutput => true,
}
...
echo "Activating python virtual environment \"canvas_manage_course\""
